...
Status: target for v1 implementation. The current prototype has hard-coded shared agent tokens, unauthenticated browser WebSockets and cleartext `ws://`; it is unsafe to expose beyond loopback.
