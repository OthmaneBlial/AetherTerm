...
- [ ] 6.3 Contributions et présentation GitHub — guide de contribution, politique de sécurité et modèles d'issues/PR ajoutés ; description et neuf topics factuels vérifiés sur la page GitHub, signalement privé activé. Un clone frais `f975a42` a suivi l'installation verrouillée et le contrôle d'onboarding macOS ; cela ne constitue pas encore un parcours par un contributeur humain externe. Image sociale 1280 × 640 préparée à partir de la vraie capture Chromium avec source HTML et empreinte dans `docs/SCREENSHOTS.md` ; son réglage sur GitHub, les liens de release et le parcours contributeur externe restent à vérifier.
