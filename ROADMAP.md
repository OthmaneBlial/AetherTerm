...
- [ ] 1.4 Protocole et ressources bornés — schémas, trames, quotas de sessions, sessions opérateur et sockets bornés, démarrage borné à 10 s, envois serveur vers navigateur/agent bornés à 3 s et limiteurs IP distincts ; charge modérée, fermeture lente et mémoire/CPU encore à mesurer.
...
- [ ] 2.3 Reconnexion et états d'erreur — ancien shell terminé et nouvel agent enregistré après redémarrage réel du serveur ; révocation arrête l'agent, backoff réinitialisé après succès ; détection d'une session opérateur perdue après redémarrage ajoutée avec parcours Chromium CI à valider ; coupure réseau du navigateur et délais mesurés à compléter.
