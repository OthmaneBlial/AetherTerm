...
- [ ] 3.2 Interface accessible et responsive — vrais boutons, focus et sortie lisible par lecteur d'écran ; débordement horizontal absent à 320, 375, 390, 768 et 1280 px dans Chrome local, parcours à 375 px vert dans Chromium, Firefox et WebKit [35449348945](https://github.com/OthmaneBlial/AetherTerm/actions/runs/35449348945), captures réelles bureau/mobile du run [35446357041](https://github.com/OthmaneBlial/AetherTerm/actions/runs/35446357041) ; interaction tactile réelle et revue clavier complète à faire.
...
- [ ] 6.1 CI bloquante — run [35449348945](https://github.com/OthmaneBlial/AetherTerm/actions/runs/35449348945) vert avec huit jobs et actions figées (Linux Python 3.13, 26 tests dont PTY réel, wheel installé, lint/typecheck, liens docs, assets Web, scans, Chromium/Firefox/WebKit, conteneur et binaire agent) ; captures navigateur conservées quand produites ; politique de blocage PR encore requise, en tension avec les pushes directs sur `main` demandés pour cette exécution.
- [ ] 6.2 Artefacts téléchargeables/installables — wheel et sdist conservés avec manifeste SHA-256 dans l'artifact CI [35447341504](https://github.com/OthmaneBlial/AetherTerm/actions/runs/35447341504) ; artifact téléchargé, empreintes vérifiées, wheel installé dans un nouveau venv macOS hors checkout et vrai PTY testé. Serveur conteneur non-root testé sur Linux CI ; binaire agent Linux x86_64 construit et utilisé pour un vrai PTY Linux dans [35448920673](https://github.com/OthmaneBlial/AetherTerm/actions/runs/35448920673). Son artifact a été téléchargé séparément sur macOS, reconnu comme ELF x86_64 et vérifié contre `SHA256SUMS`. Les artifacts CI expirent après sept jours ; installation depuis une release publiée, autres plateformes et second hôte non vérifiés.
