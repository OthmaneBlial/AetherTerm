...
- [ ] 6.1 CI bloquante — workflow Linux Python 3.13 et build Web ajoutés avec actions figées ; premier run distant, tests navigateur, scans et politique de blocage PR encore à vérifier.
