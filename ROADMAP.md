...
- [ ] 6.1 CI bloquante — run [35448920673](https://github.com/OthmaneBlial/AetherTerm/actions/runs/35448920673) vert avec actions figées (Linux Python 3.13, 26 tests dont PTY réel, wheel installé, lint/typecheck, liens docs, assets Web, scans, Chromium, conteneur et binaire agent) ; captures navigateur conservées quand produites ; politique de blocage PR encore requise, en tension avec les pushes directs sur `main` demandés pour cette exécution.
