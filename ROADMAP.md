...
- [ ] 3.3 Assets Web maîtrisés et identité visuelle — xterm.js 6.0.0 et FitAddon 0.11.0 figés, build local et licences incluses ; favicon SVG et ICO, CSP et PTY testés ; wheel installé en venv macOS propre avec assets servis localement et PTY réel ; chargement de l'interface depuis l'image conteneur et essai hors ligne explicite encore requis.
...
- [ ] 6.2 Artefacts téléchargeables/installables — wheel installé et testé sur macOS et Linux CI, serveur conteneur non-root testé avec un PTY sur Linux CI ; binaire agent Linux, installation depuis téléchargement publié et autres plateformes encore requis.
