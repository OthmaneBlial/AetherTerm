...
- [ ] 6.3 Contributions et présentation GitHub — guide de contribution, politique de sécurité et modèles d'issues/PR ajoutés ; description et neuf topics factuels vérifiés sur la page GitHub, signalement privé activé. Image sociale 1280 × 640 préparée à partir de la vraie capture Chromium avec source HTML et empreinte dans `docs/SCREENSHOTS.md` ; son réglage sur GitHub, les liens de release et un parcours contributeur externe restent à vérifier.
